...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    phase1Desc: 'Mainnet launch, X11KVS bootstrap mining, active MESCAL smart contracts (enabling gas-free sandbox agreements, escrow, vesting), and initial Masternode setup (2,100 KRISTA collateral) at block 1.',
    phase2: 'Phase 2: PoS & ADAM Consensus Integration',
    phase2Desc: 'Activation of Proof of Stake (PoS) block production and the Approach Decentralized Model (ADAM) utilizing Verifiable Random Functions (VRF) and rolling-seed committee elections at block 200.',
    phase3: 'Phase 3: PoBLS Committee Elections',
    phase3Desc: 'Activation of the cryptographic threshold lottery (block 2,000) using the supranational/blst library for secure, unbiasable validator committee selections.',
    phase4: 'Phase 4: Model D Reward Splits',
    phase4Desc: 'Activation of the Model D reward split model (50% passive payee, 10% active quorum, 25% participants, 15% block producer) at block 2,200 to secure sustainable long-term growth.',
  ...
  tr: {
    ...
    phase1Desc: 'Mainnet lansmanı, X11KVS başlangıç madenciliği, aktif MESCAL akıllı sözleşmeleri (emanet, hak ediş ve varlık tokenizasyonu) ve ilk Masternode altyapısının (2.100 KRISTA teminatı) 1. bloktan itibaren kurulması.',
    phase2: 'Aşama 2: PoS ve ADAM Konsensüs Entegrasyonu',
    phase2Desc: 'Kanıtlanmış Hisse (PoS) blok üretimi ile Doğrulanabilir Rastgele İşlevler (VRF) ve döngüsel tohum komite seçimlerini içeren ADAM konsensüsünün 200. blokta devreye alınması.',
    phase3: 'Aşama 3: PoBLS Komite Seçimleri',
    phase3Desc: '2.000. blokta supranational/blst kütüphanesi kullanan ve güvenli, manipüle edilemez doğrulayıcı komitesi seçimi sağlayan PoBLS eşik çekilişlerinin devreye alınması.',
    phase4: 'Aşama 4: Model D Ödül Dağılımı',
    phase4Desc: 'Sürdürülebilir ağ büyümesi için Model D ödül dağılım modelinin (%50 pasif MN, %10 aktif quorum, %25 doğrulayıcı seti, %15 blok üreticisi) 2.200. blokta aktif edilmesi.',
