...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    phase1: 'Phase 1: Genesis & MESCAL Activation',
    phase1Desc: 'Mainnet launch, X11KVS bootstrap mining, active MESCAL smart contracts (enabling gas-free sandbox agreements, escrow, vesting), and initial Masternode setup (20,000 KRISTA collateral) at block 1.',
    phase2: 'Phase 2: ADAM Consensus Integration',
    phase2Desc: 'Activation of the Approach Decentralized Model (ADAM) utilizing Verifiable Random Functions (VRF) and rolling-seed committee elections with 13 dynamic puzzle-solving algorithms at block 200.',
    phase3: 'Phase 3: PoS & Model D Activation',
    phase3Desc: 'Transition to Proof of Stake (PoS) block production and activation of the Model D reward split model (50% passive payee, 10% active quorum, 25% participants, 15% block producer) at block 1000.',
    phase4: 'Phase 4: PoBLS Committee Elections',
    phase4Desc: 'Activation of the cryptographic threshold lottery (block 1,200) using the supranational/blst library for secure, unbiasable validator committee selections.',
  ...
  tr: {
    ...
    phase1: 'Aşama 1: Genesis ve MESCAL Aktivasyonu',
    phase1Desc: 'Mainnet lansmanı, X11KVS başlangıç madenciliği, aktif MESCAL akıllı sözleşmeleri (emanet, hak ediş ve varlık tokenizasyonu) ve ilk Masternode altyapısının (20.000 KRISTA teminatı) 1. bloktan itibaren kurulması.',
    phase2: 'Aşama 2: ADAM Konsensüs Entegrasyonu',
    phase2Desc: 'Doğrulanabilir rastgele işlevler (VRF) ve 13 dinamik bulmaca çözme algoritmalı döngüsel tohum komite seçimlerini içeren ADAM konsensüsünün 200. blokta devreye alınması.',
    phase3: 'Aşama 3: PoS ve Model D Aktivasyonu',
    phase3Desc: 'PoS blok üretimine geçiş ve 1000. blokta Model D ödül dağılım modelinin (%50 pasif MN, %10 aktif quorum, %25 doğrulayıcı seti, %15 blok üreticisi) aktif edilmesi.',
    phase4: 'Aşama 4: PoBLS Komite Seçimleri',
    phase4Desc: '1.200. blokta supranational/blst kütüphanesi kullanan ve güvenli, manipüle edilemez doğrulayıcı komitesi seçimi sağlayan PoBLS eşik çekilişlerinin devreye alınması.',
    explorer: 'Blok Gezgini',
    downloadWallet: 'Cüzdanı İndir',
    github: 'GitHub',
